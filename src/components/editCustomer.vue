<template>
    <div>
        ...
        <el-dialog width="90%" append-to-body title="编辑客户" :visible.sync="editDialogTableVisible" :width="'70%'">
            <el-form :model="ruleForm" :rules="rulesList" ref="ruleForm">
                <el-row>
                    <el-col :span="11">
                        <el-form-item label="客户ID" prop="value" label-width="100px" width="300px !important">
                            <el-input v-model="ruleForm.id" width="150px !important"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="客户名称" prop="value" label-width="100px" width="300px !important">
...
export default {
    ...
    methods: {
        ...
        handleDelete (index, value) {
            var url = 'http://localhost:8888/customerManage/deleteCustomer';
            this.params = { customerID: value.id };
        ...
        onSubmit () {
            ...
            var url = 'http://localhost:8888/customerManage/updateCustomer';
            this.supplier = {
                id: supplierID,// 供应商ID
